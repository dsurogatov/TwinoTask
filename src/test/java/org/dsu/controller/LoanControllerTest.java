...
public class LoanControllerTest {
	...
	public void givenLoanServiceFails_whenAskApprovedLoans_ThenReturtInternalServerError() throws Exception {
		...
		when(loanService.findApprovedLoans(any(Pageable.class))).thenThrow(Exception.class);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void givenLoanServiceFails_whenAskApprovedLoansByPersonId_ThenReturtInternalServerError() throws Exception {
		
		// mock findAllApprovedByPersonId to throw the exception
